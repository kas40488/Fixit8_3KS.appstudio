...
const cacheName = 'Fixit8KatieSullivan-2020-10-05 09:48:22.607961'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit8KatieSullivan'.length) === 'Fixit8KatieSullivan') {
